...
**注：[1.x-废弃版（最后版本：1.2.6.1）](https://github.com/goldze/MVVMHabit/tree/1.2.6.1)、[2.x-顺手版（最后版本：2.0.10）](https://github.com/goldze/MVVMHabit/tree/2.0.10)已停止维护，建议使用当前[3.x-健壮版（最后版本：3.1.1）](https://github.com/goldze/MVVMHabit)。**
...
dependencies {
    ...
    implementation 'com.github.goldze:MVVMHabit:3.1.1'
}
```
或
